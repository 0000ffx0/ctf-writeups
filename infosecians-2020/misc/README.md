...
![DNA CODES](decode/img/dna_codes.png)
...
Here is a .pcap file: [inf.pcap](dump/files/inf.pcap)
...
we have a KeePass2 password database file: [key](key/files/key)
```
~$ file key
...
we have an [.iso image](filesystem/files/fsimage.iso.gz)
...
File: [infinity_is_cool.zip](infinity_zipping/files/infinity_is_cool.zip)
